...
import { drawLine, drawCircle, drawRandomLine, drawRandomCircle, getMousePos, drawHighlight, clearHighlight} from './drawUtil';
...
angular.module(MODULE_NAME, [])
  ...
  $scope.nearAnyCenterPoint = (mousePoint) => {
    var circles = Object.values($scope.circleStore);
